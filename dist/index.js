...
const blend_1 = require("./routes/image/dual/blend");
const composite_1 = require("./routes/image/dual/composite");
...
globals_1.Sarah.create('GET /image/dual/or', bit_1.imageDualOr);
globals_1.Sarah.create('GET /image/dual/add', bit_1.imageDualAdd);
globals_1.Sarah.create('GET /image/dual/sub', bit_1.imageDualSub);
globals_1.Sarah.create('GET /image/dual/mul', bit_1.imageDualMul);
globals_1.Sarah.create('GET /image/dual/div', bit_1.imageDualDiv);
globals_1.Sarah.create('GET /image/dual/composite', composite_1.imageDualComposite);
globals_1.Sarah.create('GET /image/dual/overlay', blend_1.imageDualOverlay);
